    ...
    return `
      ...
      <head>
          ...
          <style>
              ...
              .social-icons img { width: 24px; margin: 0 5px; }
          </style>
      </head>
      <body>
          <div class="container">
              ...
              <div class="content">
                  <h2>Thank You for Your Mock Interview, ${userName}!</h2>
                  <p>You recently participated in a mock interview on <strong>${interviewDate}</strong>. We value your feedback!</p>
